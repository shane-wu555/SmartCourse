...
public interface GradingService {
     ...
     * 手动批改学生提交的作业
     * @param submissionId 提交ID
     * @param questionGrades 每个问题的分数和反馈
     * @param feedback 教师的总体反馈
     */
    void manualGradeSubmission(String submissionId, Map<String, Pair<Float, String>> questionGrades, String feedback);
