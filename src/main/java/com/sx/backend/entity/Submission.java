...
public class Submission {
    ...
    public Submission(String submissionId, String taskId, String studentId, LocalDateTime submitTime, SubmissionStatus status, String content, List<FileMeta> files, Float grade, String feedback, LocalDateTime gradeTime) {
